...
public class MainActivity extends AppCompatActivity {
    ...
    // Modelo fijo
    private String selectedModel = "batimobile.glb";

    // Estados de la cruceta
    ...
    private final Runnable dpadLoop = new Runnable() {
        ...
        public void run() {
            ...
            dpadHandler.postDelayed(this, 16); // ~60 FPS
        }
    };
    ...
    private void loadModel() {
        ModelRenderable.builder()
                .setSource(this, android.net.Uri.parse(selectedModel))
                .setIsFilamentGltf(true)
                .build()
                .thenAccept(renderable -> carRenderable = renderable)
                .exceptionally(throwable -> {
                    Toast.makeText(this, "Error cargando el modelo Batimóvil", Toast.LENGTH_SHORT).show();
